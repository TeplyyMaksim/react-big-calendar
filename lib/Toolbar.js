    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            type: 'button',
            className: (0, _classnames2.default)('rbc-toolbar-btn-' + messages.today.toLowerCase()),
            onClick: this.navigate.bind(null, _constants.navigate.TODAY)
          },
          _react2.default.createElement(
            'span',
            { className: 'rbc-toolbar-btn-message' },
            messages.today
          )
        ),
        _react2.default.createElement(
          ...
          {
            type: 'button',
            className: (0, _classnames2.default)('rbc-toolbar-btn-' + messages.previous.toLowerCase()),
        ...
        _react2.default.createElement(
          ...
          {
            type: 'button',
            className: (0, _classnames2.default)('rbc-toolbar-btn-' + messages.next.toLowerCase()),
      ...
      return viewNames.map(function (name) {
        return _react2.default.createElement(
          ...
          { type: 'button', key: name,
            className: (0, _classnames2.default)('rbc-toolbar-btn-' + name.toLowerCase(), { 'rbc-active': view === name }),
...
Toolbar.propTypes = {
  ...
  additionalContent: _propTypes2.default.node
};
