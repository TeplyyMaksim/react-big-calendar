    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('rbc-event', className, xClassName, (_cn = {
            'rbc-selected': selected,
            'rbc-event-allday': isAllDay || _dates2.default.diff(start, _dates2.default.ceil(end, 'day'), 'day') > 1
          }, _cn['rbc-event-type-' + event.type] = event.type, _cn['rbc-event-feature-' + event.resourceId] = event.resourceId, _cn['rbc-event-continues-prior'] = continuesPrior, _cn['rbc-event-continues-after'] = continuesAfter, _cn)),
