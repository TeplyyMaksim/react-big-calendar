...
var DaySlot = function (_React$Component) {
  ...
  DaySlot.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot', _dates2.default.isToday(max) && 'rbc-today', this.props.lastDayColumn && 'rbc-last-day-column'),
        now: now,
        min: min,
        max: max,
        step: step
...
DaySlot.propTypes = {
  ...
  lastDayColumn: _react2.default.PropTypes.bool
};
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            className: (0, _classnames2.default)('rbc-event', className, (_cn = {
              'rbc-selected': _isSelected
            }, _cn['rbc-event-type-' + event.type] = event.type, _cn['rbc-event-feature-' + event.resourceId] = event.resourceId, _cn['rbc-event-continues-earlier'] = continuesPrior, _cn['rbc-event-continues-later'] = continuesAfter, _cn))
          },
          _react2.default.createElement(
            'div',
