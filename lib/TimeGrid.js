...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    var eventsRendered = resources ? this.renderEventsWithResource(range, rangeEvents, this.props.now, resources) : this.renderEvents(range, rangeEvents, this.props.now);

    return _react2.default.createElement(
      'div',
      { className: (0, _classnames2.default)('rbc-time-view', 'rbc-' + (range.length > 1 ? 'week' : 'day') + '-view') },
  ...
  TimeGrid.prototype.renderEventsWithResource = function renderEventsWithResource(range, events, today, resources) {
    var _this3 = this;
    ...
    return range.map(function (date, idx) {
      ...
      return resources.map(function (resource, id) {
        ...
        var eventsToDisplay = daysEvents.filter(function (event) {
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range, events, today, id) {
    var _this4 = this;

    var _props4 = this.props,
        min = _props4.min,
        max = _props4.max,
        endAccessor = _props4.endAccessor,
        startAccessor = _props4.startAccessor,
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.range.length > 1 || !this.props.resources ? this.props.gutterAdditionalContent : null
        ),
      ...
      resources && _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'rbc-label rbc-header-gutter', style: { width: width } },
          this.props.range.length <= 1 ? this.props.gutterAdditionalContent : null
        ),
        headerRendered
      ),
      _react2.default.createElement(
    ...
    return range.map(function (date, i) {
      ...
      return _react2.default.createElement(
        'div',
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', _dates2.default.isToday(date) && 'rbc-today'),
          style: (0, _eventLevels.segStyle)(1, _this7.slots)
        },
